...
This image runs
[Chef Server 12](https://downloads.chef.io/chef-server/). It's a fork of
[3ofcoins/docker-images/public/chef-server](https://github.com/3ofcoins/docker-images/tree/master/public/chef-server).
